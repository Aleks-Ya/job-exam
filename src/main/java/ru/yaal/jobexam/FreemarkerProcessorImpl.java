 ...
 */
public class FreemarkerProcessorImpl implements FreemarkerProcessor {
    private Template template;

    public FreemarkerProcessorImpl() throws IOException {
        Configuration cfg = new Configuration(Configuration.VERSION_2_3_22);
        cfg.setClassForTemplateLoading(FreemarkerProcessorImpl.class, "templates");
